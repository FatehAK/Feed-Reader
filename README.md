# FeedSly
FeedSly retrieves feeds from websites using the Google Feeds API. The primary goal of this project is to demostrate browser based testing using the Jasmine testing library. It is developed following the TDD (Test Driven Development) methodology.
